...
const ListItem = (props) => (
  ...
  <div className="item recommendations">
    ...
    <span className="review recommendations">
      <span className="icon recommendations">
      ...
      <span className="rating recommendations">&nbsp;{props.detail.avg_review.toString().slice(0, 4)} <span className="greyFont">({props.detail.num_review})</span></span>
    </span>
    </div>
    <div className="line2 regularFont recommendations">{props.detail.listing_title}</div>
    <div className="line3 regularFont recommendations">
      <span>
        <span className="price recommendations">${props.detail.night_price.toString().slice(0, 3)}</span>
        <span> / night</span>
      </span>
    </div>
  </div>
